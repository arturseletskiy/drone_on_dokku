just run `./play drone-server.yml`

set -o nounset -o pipefail -o errexit; set -o allexport; source .env; set +o allexport; ansible-playbook drone-server.yml -v -i inventory.yml
